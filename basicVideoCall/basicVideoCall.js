...
function logStats() {
  let statsList = Object.values(client.getRemoteVideoStats());
  if(statsList.length> 0){
    let stats = statsList[0]
    console.log("Codec:"+ stats.codecType );
    console.log("FPS:"+ stats.receiveFrameRate );
    console.log(stats.receiveResolutionHeight + "x"+ stats.receiveResolutionWidth );  
  }
}
/*
